    ...
    return (
        <div>
          ...
          ">
                            ...
                            <p>
                                Meta School provide you best Premium corses in the market. You replay on us fully to fullfill desires.
                            </p>
                        </div>
                        <div className="">
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Data Science</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Art & Design
                                </a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Health & Fitness
                                </a>
                            </p>
                            <p>
                ...
                <div className="text-center p-6 bg-blue-200">
                    ...
                    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Meta School</a>
                </div>
            </footer>
        </div>
    );
